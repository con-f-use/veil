...
data() { # get data from NixOS configuration
...
veil:data() { # print data for a given machine
  jq . <<< "$VEIL_DATA"
...
veil:deploy() { # deploy a given configuration
  local deploy_opts=()
